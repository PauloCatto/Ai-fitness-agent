...
describe('DashboardChartsComponent', () => {
  ...
  it('should have volume chart canvas', () => {
    expect(component.volumeCanvas).toBeDefined();
  });

  it('should have fatigue chart canvas', () => {
    expect(component.fatigueCanvas).toBeDefined();
  });
});
